...
MyLeagueRequestBottomDilog(BuildContext buildContext,String league_name,String uuid,String status){
              ...
              child: Column(
                ...
                children: <Widget>[
                    Padding(
                      ...
                      child: Text('Are you sure you want to $status this $league_name',
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(child: InkWell(
                          onTap: (){
                            Navigator.pop(context);
                            locator<MyLeaguesProvider>().sendPlayerLeagueStatus(buildContext,uuid,status);
                          },
                          child: Container(
                            height: 45,
