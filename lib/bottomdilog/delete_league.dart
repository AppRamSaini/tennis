...
DeleteLeagueBottomDilog(BuildContext buildContext,String leagueUUID,String leagueName){
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                      ...
                      child: Text('Are you sure you want to Delete $leagueName League',
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(child: InkWell(
                          onTap: (){
                            Navigator.pop(context);
                            locator<MyLeaguesProvider>().deleteLeague(buildContext,leagueUUID);
                          },
                          child: Container(
                            height: 45,
