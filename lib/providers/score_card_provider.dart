...
class ScoreCardProvider extends ChangeNotifier {
  ...
  void superTieBreakValueCheck(String win,String los,String tieWin,String tieLos){
     if(win.isNotEmpty && los.isNotEmpty){

     }else if(tieWin.isNotEmpty && tieLos.isNotEmpty){

     }else if (win.isNotEmpty && los.isNotEmpty && tieWin.isNotEmpty && tieLos.isNotEmpty){
